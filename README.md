...
Update ChatRWKV v2 & pip rwkv package (0.5.0) and set os.environ["RWKV_CUDA_ON"] = '1' for extreme speed f16i8 (23 tokens/s on 3090) (and 10% less VRAM, now 14686MB for 14B instead of 16462MB  - use it to put more layers on GPU).
