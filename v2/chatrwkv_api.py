...
if CHAT_LANG == 'English':
    ...
    args.MODEL_NAME = '/fsx/BlinkDL/HF-MODEL/rwkv-4-raven/RWKV-4-Raven-7B-v11-Eng49_hn49_pn1_ther1_0230430-ctx8192'
...
def on_message():
    ...
    if x_top_p <= 0:
        x_top_p = 0
    msg = msg.strip()
    #http/https request %2Breset relpace +reset
    if msg == '+reset':
